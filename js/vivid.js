...
if(!vivid_init){
	...
	$.getJSON("http://juicer.herokuapp.com/api/article?url=" + url + "",
		function (data) {
			...
			$('#vivid_note_tool').append('<button id="vivid_MT" type="button" class="btn btn-primary" data-toggle="modal" data-target="#MTBox">Translation</button>');
			...
			$('body').append('<div class="modal fade" id="MTBox" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"><div class="modal-dialog modal-sm"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button><h4 class="modal-title" id="myModalLabel">Machine Translation</h4></div><div class="modal-body"></div><div class="modal-footer"></div></div></div></div>');
